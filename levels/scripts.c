...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_YELLOW_COIN,             ssk_yellow_coin_geo),
    LOAD_MODEL_FROM_GEO(MODEL_STAR,                    RCP_HmsItemStar),

    LOAD_MODEL_FROM_GEO(MODEL_RED_STAR,                red_star_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_YELLOW_COIN_NO_SHADOW,   ssk_yellow_coin_no_shadow_geo),
