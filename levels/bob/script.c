...
const LevelScript level_bob_entry[] = {
	...
	END_AREA(),
	AREA(3, bob_area_3),
		OBJECT(MODEL_YELLOW_COIN, -1391, -1612, -2254, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -1392, -961, -3528, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -3216, -270, -5367, 0, 90, 0, 0x00000000, bhvYellowCoin),
		...
		OBJECT(MODEL_GOOMBA, -1223, -2262, -1320, 0, 90, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -188, -2262, -815, 0, 90, 0, 0x00000000, bhvGoomba),
		MARIO_POS(3, 90, 0, 492, 0),
		OBJECT(MODEL_NONE, 0, 492, 0, 0, 90, 0, (0xA << 24) | (0xA << 16) | (0xA << 8) | (0xA), bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -2481, -270, 34, 0, 90, 0, 0x00000000, bhvGoombaTripletSpawner),
