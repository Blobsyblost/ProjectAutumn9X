...
const LevelScript level_bob_entry[] = {
	...
	END_AREA(),
	AREA(2, bob_area_2),
		OBJECT(MODEL_BLACK_BOBOMB, 1450, 748, 830, 0, 80, 0, 0x00000000, bhvBobomb),
		OBJECT(MODEL_NONE, 1261, 667, 2512, 0, 80, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_BLACK_BOBOMB, 299, 2276, 1686, 0, 80, 0, 0x00000000, bhvBobomb),
