...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(70, LEVEL_BOB, 3, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(80, LEVEL_BOB, 4, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -1711, 330, -4670, 0, 0, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -6301, -1871, -4618, 0, 0, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -5302, 13, 1996, 0, 90, 0, 0x00000000, bhvDoor),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -6377, -1855, -5813, 0, 0, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -6224, -1855, -5813, 0, -180, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_NONE, -8026, -3093, -6405, 0, -180, 0, (25 << 24) | (80 << 16), bhvWarp),
		...
		OBJECT(MODEL_NONE, -1800, -1593, -7750, 0, -180, 0, (25 << 24) | (70 << 16), bhvWarp),
		OBJECT(MODEL_NONE, -1711, -241, -1786, 0, 0, 0, (10 << 24) | (71 << 16), bhvLaunchDeathWarp),
		OBJECT(MODEL_NONE, -2385, -1584, -7750, 0, 90, 0, (10 << 24) | (75 << 16), bhvLaunchDeathWarp),
		...
		OBJECT(MODEL_NONE, -2385, -1584, -7750, 0, 90, 0, (10 << 24) | (77 << 16), bhvAirborneStarCollectWarp),
