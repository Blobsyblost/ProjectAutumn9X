...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 1627, -115, -20, 0, 90, 0, (10 << 24) | (10 << 16) | (10 << 8) | (10), bhvDoorWarp),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -5205, -231, 1919, 0, -90, 0, 0x00000000, bhvDoorWarp),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -1711, -231, -3255, 0, 0, 0, 0x00000000, bhvDoorWarp),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -2099, -275, 3400, 0, -180, 0, 0x00000000, bhvDoorWarp),
		OBJECT(MODEL_STAR, -4381, 23, -4589, 0, 0, 0, (1 << 24) | (1 << 16) | (1 << 8) | (1), bhvStar),
		OBJECT(MODEL_NONE, -1711, -598, -1786, 0, 0, 0, (5 << 24) | (11 << 16), bhvWarp),
