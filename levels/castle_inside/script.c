...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_NONE, -6301, -1871, -3417, 0, 0, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -6377, -1855, -4612, 0, 0, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -6224, -1855, -4612, 0, -180, 0, 0x00000000, bhvDoor),
		...
		OBJECT(MODEL_NONE, -1800, -1593, -6548, 0, -180, 0, (25 << 24) | (70 << 16), bhvWarp),
		OBJECT(MODEL_NONE, -1711, -241, -1786, 0, 0, 0, (10 << 24) | (71 << 16), bhvLaunchDeathWarp),
		OBJECT(MODEL_NONE, -2385, -1584, -6548, 0, 90, 0, (10 << 24) | (75 << 16), bhvLaunchDeathWarp),
		...
		OBJECT(MODEL_NONE, -2385, -1584, -6548, 0, 90, 0, (10 << 24) | (77 << 16), bhvAirborneStarCollectWarp),
